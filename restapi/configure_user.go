...
import (
	...
	"github.com/klumhru/starlight-user/restapi/operations"
	"github.com/klumhru/starlight-user/restapi/operations/userhealthz"
	"github.com/klumhru/starlight-user/restapi/operations/users"
)
...
func configureAPI(api *operations.UserAPI) http.Handler {
	...
	api.UsersGetIDHandler = users.GetIDHandlerFunc(func(params users.GetIDParams) middleware.Responder {
		return middleware.NotImplemented("operation users.GetID has not yet been implemented")
	})
	...
	api.UserhealthzGetHealthzHandler = userhealthz.GetHealthzHandlerFunc(func(params userhealthz.GetHealthzParams) middleware.Responder {
		return middleware.NotImplemented("operation userhealthz.GetHealthz has not yet been implemented")
	})
