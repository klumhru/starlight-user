...
func NewUserAPI(spec *loads.Document) *UserAPI {
	return &UserAPI{
		...
		UsersGetIDHandler: users.GetIDHandlerFunc(func(params users.GetIDParams) middleware.Responder {
			return middleware.NotImplemented("operation UsersGetID has not yet been implemented")
		}),
		...
		UserhealthzGetHealthzHandler: userhealthz.GetHealthzHandlerFunc(func(params userhealthz.GetHealthzParams) middleware.Responder {
			return middleware.NotImplemented("operation UserhealthzGetHealthz has not yet been implemented")
		}),
...
/*UserAPI A user resource with identity Information */
type UserAPI struct {
	spec            *loads.Document
	...
	// UsersGetIDHandler sets the operation handler for the get ID operation
	UsersGetIDHandler users.GetIDHandler
	...
	// UserhealthzGetHealthzHandler sets the operation handler for the get healthz operation
	UserhealthzGetHealthzHandler userhealthz.GetHealthzHandler
...
func (o *UserAPI) Validate() error {
	...
	if o.UsersGetIDHandler == nil {
		unregistered = append(unregistered, "users.GetIDHandler")
	}
	...
	if o.UserhealthzGetHealthzHandler == nil {
		unregistered = append(unregistered, "userhealthz.GetHealthzHandler")
	}
...
func (o *UserAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/{id}"] = users.NewGetID(o.context, o.UsersGetIDHandler)

	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"][""] = users.NewCreateUser(o.context, o.UsersCreateUserHandler)
	...
	o.handlers["GET"]["/healthz"] = userhealthz.NewGetHealthz(o.context, o.UserhealthzGetHealthzHandler)

	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"][""] = users.NewListUsers(o.context, o.UsersListUsersHandler)
